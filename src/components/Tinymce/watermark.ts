;(function (root, factory) {
  ...
  var loadMark = function (settings) {
    ...
    /* 如果元素存在则移除*/
    const watermark_element = document.getElementById(
    ...
    /* 如果设置水印挂载的父元素的id*/
    const watermark_parent_element = document.getElementById(
    ...
    const temp_watermark_x_space = parseInt(
      (page_width -
        defaultSettings.watermark_x -
    ...
    const temp_watermark_y_space = parseInt(
      (page_height -
        defaultSettings.watermark_y -
