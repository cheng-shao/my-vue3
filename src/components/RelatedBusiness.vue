<template>
  <div :style="{ 'margin-left': marginLeft }" class="related-business-wrap">
...
export default {
  ...
  emits: ['checkInfos', 'changeInfos', 'unbind'],
  components: {
    CrmRelative: defineAsyncComponent(() =>
      import('@/components/CreateCom/CrmRelative.vue')
    ),
    RelatedBusinessCell
  },
  props: {
