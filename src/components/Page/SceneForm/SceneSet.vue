  ...
  >
    <span slot="title" class="el-dialog__title"
      >场景管理<i
        ...
        :data-type="config.help.type"
        :data-id="config.help.id"
    /></span>
    ...
    <flexbox class="scene-list">
      <div class="scene-list-box">
        <flexbox class="scene-list-head">
          ...
          <div class="scene-list-head-detail">
            {{ leftCheckItems.length + '/' + checkedLeftData.length }}
          </div>
        </flexbox>
      ...
      <div class="scene-list-box">
        <flexbox class="scene-list-head">
          ...
          <div class="scene-list-head-detail">
            {{ rightCheckItems.length + '/' + checkedRightData.length }}
          </div>
        </flexbox>
        <div class="scene-list-body">
          <draggable
    ...
    <scene-create
      ...
      v-model:dialog-visible="showCreateScene"
      :obj="filterObj"
      :name="filterName"
...
export default {
  ...
  methods: {
    ...
    handleConfirm(hasMessage = true) {
      ...
      const leftTemps = this.checkedLeftData.filter((item) => {
      ...
      this.config
        .sortRequest({
          ...
          noHideIds: this.checkedLeftData.map((item) => item.sceneId),
          hideIds: this.checkedRightData.map((item) => item.sceneId),
          ...
          if (type == 'edit') {
            ...
            this.filterObj = {
              ...
              obj: data.data.filter((item) =>
                validFieldNames.includes(item.name)
              )
            }
    ...
    handleleftCheckAllChange(value) {
      ...
      this.leftCheckItems = value
        ? this.checkedLeftData.filter((item) => {
            return item.check
          })
        : []
    },
