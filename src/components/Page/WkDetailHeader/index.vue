  ...
  <div class="wk-detail-header">
    ...
    <flexbox class="wk-detail-header-body" justify="space-between">
      <div class="wk-detail-header-left">
        ...
        <slot name="left" />
        <el-button-group
          v-if="pageList && pageList.length > 1"
          class="wk-detail-header-page-switch"
        >
          <el-button
            type="subtle"
            icon="el-icon-arrow-left"
            @click="$emit('pageChange', 'left')"
          />
          <el-button
            type="subtle"
            icon="el-icon-arrow-right"
            @click="$emit('pageChange', 'right')"
          />
        </el-button-group>
      </div>
      ...
      <div class="wk-detail-header-right">
        ...
        <el-dropdown
          ...
          trigger="click"
          :class="{ 'margin-left-interval': this.$slots.right }"
