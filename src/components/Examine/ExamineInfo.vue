<template>
  <div
    ...
    class="approval-flow"
  >
    <flexbox class="approval-flow__hd" justify="space-between">
      <div class="approval-flow__hd--left">
        <!-- <i class="wk wk-approve flow-icon" /> -->
        <span class="flow-title">审批流信息</span>
        <el-popover
          ref="popover"
        ...
        >
          ...
          />
          <template #reference>
            <el-button type="text">查看历史审批流程</el-button>
          </template>
        </el-popover>
      </div>
      ...
      <div class="approval-flow__hd--right">
        ...
        <el-button
          ...
          >拒绝</el-button
        >
        <el-button v-if="examineInfo.isRecheck == 1" @click="examineHandle(4)"
          >撤回</el-button
        >
      </div>
    </flexbox>
    ...
    <!-- 固定 -->
    <flexbox class="check-items" wrap="wrap">
      <el-popover
