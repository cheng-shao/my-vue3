...
export default {
  ...
  methods: {
    ...
    start: function(e) {
      ...
      if (this.isEnd == false) {
        this.text = ''
        this.moveBlockBackgroundColor = '#0052CC'
        this.leftBarBorderColor = '#0052CC'
        this.leftBarBackground = '#DEEBFF'
        this.iconColor = '#fff'
        e.stopPropagation()
        this.status = true
      }
    ...
    refresh: function() {
      ...
      this.leftBarBorderColor = '#DFE1E6'
      this.moveBlockBackgroundColor = undefined
      this.iconColor = '#42526E'
