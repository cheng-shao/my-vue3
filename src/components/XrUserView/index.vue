    ...
    <div v-if="userData" class="xr-mian">
      ...
      <div class="xr-mian__bd">
        <flexbox class="info-cell">
          ...
          <div class="info-cell__value text-one-line">
            {{ userData.deptName }}
          </div>
        </flexbox>
        <flexbox class="info-cell">
        ...
        <flexbox class="info-cell">
          ...
          <div :title="userData.mobile" class="info-cell__value text-one-line">
            {{ userData.mobile }}
          </div>
        </flexbox>
        <flexbox class="info-cell">
          ...
          <div :title="userData.email" class="info-cell__value text-one-line">
            {{ userData.email }}
          </div>
        </flexbox>
      </div>
