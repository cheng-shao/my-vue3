<template>
  ...
  >
    ...
    >
      <i v-if="!disabled" class="wukong wukong-file f-logo" />
    ...
    <div class="f-body">
      <flexbox v-for="(item, index) in dataValue" :key="index" class="f-item">
        <i class="wukong wukong-file f-img" />
        <div class="f-name" @click="perviewClick(item, index)">
          {{ fileName(item) }}
        </div>
        <div
          v-if="!disabled"
