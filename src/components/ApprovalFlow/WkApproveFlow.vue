<template>
  <div class="wk-approve-flow-wrap">
    ...
    >
      ...
      <wk-end-node />
      <wk-condition-set
        v-model:visible="conditionSetVisible"
        :node="editNode"
      ...
      />
      <wk-node-set
        v-model:visible="nodeSetVisible"
        :node="editNode"
        :props="config"
      />
      <WkCopyNodeSet
        v-model:visible="copyNodeSetVisible"
        :node="editNode"
        :props="config"
      />
    </div>
...
import WkConditionWrap from './WkConditionWrap.vue'
