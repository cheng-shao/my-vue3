  ...
  >
    <flexbox v-if="editNode" class="drawer-header">
      <div class="edit-title">
        ...
        />
        <template v-else>
          <span class="title" @click="isNameEdit = true">{{
            editNode.name
          }}</span>
    ...
    <div v-if="editNode" class="drawer-body">
      <div class="section">
        ...
        <div v-if="editNode.examineType === 1" class="area-top">
          <div class="section-handle">
            <el-button type="primary" @click="depUserViewDialogShow = true"
              >添加员工</el-button
            >
        ...
        <div v-if="editNode.examineType === 2" class="area-top">
          ...
          <div class="area-top wk-checkbox">
            <el-checkbox
              ...
              :false-label="0"
            />
            <span class="wk-checkbox__label"
              >找不到主管时，由上级主管代审批</span
            >
          </div>
        </div>
        ...
        <div v-if="editNode.examineType === 4" class="area-top">
          ...
          <div class="area-top">
            ...
            <div class="area-top">
              <el-select v-model="editNode.rangeType" @change="rangeTypeChange">
        ...
        <div v-if="editNode.examineType === 5" class="area-top">
          ...
          >
            <el-radio :label="1" class="el-radio--block">
              <div>
                指定角色（连续多级上级须包含该角色）<role-employee-select
                  ref="roleSelect"
                  v-model="editNode.roleId"
                  :props="{
                    onlyShowRole: true
            ...
            >
              ...
              <span
                ...
                style="margin-right: 8px; font-size: 13px"
                >同时不超过发起人向上的</span
              >
              <el-select v-model="editNode.parentLevel">
                <el-option
            ...
            <el-radio :label="2" class="el-radio--block area-top"
              ><span>组织架构中由上至下的</span
              ><el-select
      ...
      <!-- 审批方式-->
      <div v-if="waySectionShow" class="section">
        ...
        <div class="section__content">
          <el-radio-group v-model="editNode.type">
            <el-radio
              ...
              >依次审批</el-radio
            >
            <el-radio :label="2" class="el-radio--block"
              >会签（需所有审批人同意）</el-radio
            >
            <el-radio :label="3" class="el-radio--block"
...
export default {
  ...
  methods: {
    ...
    examineTypeChange() {
      ...
      if (this.editNode.examineType === 2) {
        // 指定成员
        this.editNode.type = 1 // 多人审批类型
      } else if (this.editNode.examineType === 2) {
        // 上级
        this.editNode.type = 0 // 当审批类型为主管时
      } else if (this.editNode.examineType === 3) {
        // 角色
        this.editNode.type = 2 // 多人审批类型
      } else if (this.editNode.examineType === 4) {
        // 发起人自选
        ...
        this.editNode.type = 1 // 多人审批类型
      } else if (this.editNode.examineType === 5) {
        // 连续多级上级
    ...
    selectUserChange(userIds, _, users) {
      if (users.length > 0) {
        if (this.editNode.examineType === 1) {
          this.editNode.userList =
            users.length > 20 ? users.slice(0, 20) : users
