<template>
  <flexbox class="dept-check-cell dept-cell" @click="cellClick">
    <el-checkbox ref="checkbox" v-bind="$attrs" @click.stop="" />
    <div class="dept-cell__hd text-one-line" :title="item[config.label]">
      {{ item[config.label] }}
    </div>
