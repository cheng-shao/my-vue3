 ...
 * @LastEditTime: 2022-05-25 10:45:33
 * @LastEditors: yang
-->
<template>
  <flexbox class="wk-file-cell">
    ...
    <div class="wk-file-cell__size">({{ data.size | getFileSize }})</div>
    <div class="wk-file-cell__footer">
      <template>
        ...
        <span v-if="deleteShow" class="xr-text-btn delete" @click="deleteClick"
          >删除</span
        >
      </template>
    </div>
