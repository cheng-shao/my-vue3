    ...
    <template v-if="showType === 'default'">
      ...
      >
        <flexbox class="detail-item__head">
          <div class="detail-item__head-title">
        ...
        >
          <template v-for="(item, index) in children">
            <div
              ...
              :label="item.name"
              :style="{
                width: item.stylePercent ? `${item.stylePercent}%` : 'auto'
              }"
              class="wk-form-item"
            >
...
export default {
  ...
  components: {
    WkFieldView: defineAsyncComponent(() =>
      import('@/components/NewCom/WkForm/WkFieldView.vue')
    )
  },
