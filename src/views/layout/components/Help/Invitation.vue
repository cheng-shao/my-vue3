...
export default {
  ...
  watch: {},
  created() {
    this.text = `【${this.name}】企业管理员${this.userInfo.realname}给你发来链接 https://www.baidu.com ，点击进入悟空云一起协作工作吧！链接24小时内有效，为确保企业信息安全，切勿随意传播该条信息，客户服务热线4000812558【悟空云】`
  },
  mounted() {},
  methods: {
